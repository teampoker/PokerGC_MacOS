...
ConfigFile::ConfigFile(char *argv0, bool readonly) : noWriteAccess(readonly)
{
	...
	configList.push_back(ConfigInfo("InternetServerConfigMode", CONFIG_TYPE_INT, "1"));
	...
	//configList.push_back(ConfigInfo("InternetServerAddress", CONFIG_TYPE_STRING, "52.0.24.151"));
	configList.push_back(ConfigInfo("InternetServerAddress", CONFIG_TYPE_STRING, "ec2-52-0-24-151.compute-1.amazonaws.com"));
	...
	configList.push_back(ConfigInfo("MyName", CONFIG_TYPE_STRING, ""));
	...
	configList.push_back(ConfigInfo("Opponent1Name", CONFIG_TYPE_STRING, ""));
	configList.push_back(ConfigInfo("Opponent1Avatar", CONFIG_TYPE_STRING, "data/gfx/avatars/default/people/alien-1.png"));
	configList.push_back(ConfigInfo("Opponent2Name", CONFIG_TYPE_STRING, ""));
	configList.push_back(ConfigInfo("Opponent2Avatar", CONFIG_TYPE_STRING, "data/gfx/avatars/default/people/thinking-dean.png"));
	configList.push_back(ConfigInfo("Opponent3Name", CONFIG_TYPE_STRING, ""));
	configList.push_back(ConfigInfo("Opponent3Avatar", CONFIG_TYPE_STRING, "data/gfx/avatars/default/people/john-wayne.png"));
	configList.push_back(ConfigInfo("Opponent4Name", CONFIG_TYPE_STRING, ""));
	configList.push_back(ConfigInfo("Opponent4Avatar", CONFIG_TYPE_STRING, "data/gfx/avatars/default/people/gaga.png"));
	configList.push_back(ConfigInfo("Opponent5Name", CONFIG_TYPE_STRING, ""));
	configList.push_back(ConfigInfo("Opponent5Avatar", CONFIG_TYPE_STRING, "data/gfx/avatars/default/people/norma-jean.png"));
	configList.push_back(ConfigInfo("Opponent6Name", CONFIG_TYPE_STRING, ""));
	configList.push_back(ConfigInfo("Opponent6Avatar", CONFIG_TYPE_STRING, "data/gfx/avatars/default/people/emc2.png"));
	configList.push_back(ConfigInfo("Opponent7Name", CONFIG_TYPE_STRING, ""));
	configList.push_back(ConfigInfo("Opponent7Avatar", CONFIG_TYPE_STRING, "data/gfx/avatars/default/people/raymor-glasses.png"));
	configList.push_back(ConfigInfo("Opponent8Name", CONFIG_TYPE_STRING, ""));
	configList.push_back(ConfigInfo("Opponent8Avatar", CONFIG_TYPE_STRING, "data/gfx/avatars/default/people/depp.png"));
	configList.push_back(ConfigInfo("Opponent9Name", CONFIG_TYPE_STRING, ""));
	configList.push_back(ConfigInfo("Opponent9Avatar", CONFIG_TYPE_STRING, "data/gfx/avatars/default/people/philvey.png"));
...
void ConfigFile::checkAndCorrectPlayerNames()
{
	...
	if (playerNames.size() < 10 || playerNames.find("") != playerNames.end()) {
		...
		writeConfigString("MyName", "Username");
		...
		writeConfigString("Opponent1Name", "Worker Alien");
		writeConfigString("Opponent2Name", "James Dean");
		writeConfigString("Opponent3Name", "John Wayne");
		writeConfigString("Opponent4Name", "Poker Face");
		writeConfigString("Opponent5Name", "Norma Jean");
		writeConfigString("Opponent6Name", "Einstein");
		writeConfigString("Opponent7Name", "Fossilman");
		writeConfigString("Opponent8Name", "Warrior");
		writeConfigString("Opponent9Name", "NoHomeJerome");
	}
}
