...
#include "../src/gui/qt/gametable/mychancelabel.h"
...
struct qt_meta_stringdata_MyChanceLabel_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MyChanceLabel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MyChanceLabel_t qt_meta_stringdata_MyChanceLabel = {
    {
QT_MOC_LITERAL(0, 0, 13) // "MyChanceLabel"
...
const QMetaObject MyChanceLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_MyChanceLabel.data,
      qt_meta_data_MyChanceLabel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MyChanceLabel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyChanceLabel.stringdata0))
