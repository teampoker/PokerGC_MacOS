...
struct qt_meta_stringdata_gameTableImpl_t {
    ...
    char stringdata0[3972];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_gameTableImpl_t, stringdata0) + ofs \
...
void *gameTableImpl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_gameTableImpl.stringdata0))
