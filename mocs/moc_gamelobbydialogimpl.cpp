...
struct qt_meta_stringdata_gameLobbyDialogImpl_t {
    ...
    char stringdata0[1703];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_gameLobbyDialogImpl_t, stringdata0) + ofs \
...
void *gameLobbyDialogImpl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_gameLobbyDialogImpl.stringdata0))
