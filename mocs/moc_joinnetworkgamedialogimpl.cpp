...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_joinNetworkGameDialogImpl_t, stringdata0) + ofs \
...
void *joinNetworkGameDialogImpl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_joinNetworkGameDialogImpl.stringdata0))
